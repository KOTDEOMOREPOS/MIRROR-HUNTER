...
class _BotCommands:
    def __init__(self):
        ...
        self.MirrorCommand = getCommand('MIRROR_BOT', f'mirror{BOT_NO}')
        self.UnzipMirrorCommand = getCommand('UNZIP_BOT', f'unzipmirror{BOT_NO}')
        self.ZipMirrorCommand = getCommand('ZIP_BOT', f'zipmirror{BOT_NO}')
        ...
        self.ExecHelpCommand = getCommand('EXEHELP_BOT', f'exehkor{BOT_NO}')
        self.LeechSetCommand = getCommand('LEECH_SET', f'settingsfuck{BOT_NO}')
        self.SetThumbCommand = getCommand('SET_THUMB', f'seootthumb{BOT_NO}')
        self.LeechCommand = getCommand('LEECH_BOT', f'leecooh{BOT_NO}')
        self.UnzipLeechCommand = getCommand('UNZIP_LEECH', f'unzipleooech{BOT_NO}')
        self.ZipLeechCommand = getCommand('ZIP_LEECH', f'zipleooech{BOT_NO}')
        self.QbLeechCommand = getCommand('QBIT_LEECH', f'qbleeooch{BOT_NO}')
        self.QbUnzipLeechCommand = getCommand('QBITUNZIP_LEECH',  f'qbunziplooeech{BOT_NO}')
        self.QbZipLeechCommand = getCommand('QBITZIP_LEECH', f'qbzipooleech{BOT_NO}')
        self.LeechWatchCommand = getCommand('WATCH_LEECH', f'leechwaootch{BOT_NO}')
        self.LeechZipWatchCommand = getCommand('WATCHZIP_LEECH', f'leechzioopwatch{BOT_NO}')
